...
1. **Install Git** (if needed): [git-scm.com](https://git-scm.com/) — use the default options.

2. **Create a new repository on GitHub**
   - Go to [github.com/new](https://github.com/new).
   - Choose a name (e.g. `condition-builder`), leave “Add a README” unchecked, then click **Create repository**.

3. **Initialize Git and push** (run these in the project folder):
